...
def training_direction_pred(model_folder_name, 
    ...
    for pre_trained in [True, False]:
        ...
        model_string += f"_pretrained_{str(use_pretrained_model)}"
    ...
    for video_type in making_video_type:
        create_visualization_video(model_name_for_visualization, video_type=video_type)
    
if __name__ == "__main__":
    model_string = "city_and_forest_wba_value_whole_features"
    video_name = {
        0 : 'bird',
        1 : 'city',
        2 : 'forest'
